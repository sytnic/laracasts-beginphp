        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/"            class="<?php echo $_SERVER['REQUEST_URI'] == "/" ? "bg-gray-900 text-white " : "text-gray-300 "; ?>              
                                            hover:bg-gray-700 hover:text-white  rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
              
              <a href="/about.php"   class="<?php echo $_SERVER['REQUEST_URI'] == "/about.php" ? "bg-gray-900 text-white " : "text-gray-300 "; ?>
                                            hover:bg-gray-700 hover:text-white  rounded-md px-3 py-2 text-sm font-medium">About</a>
              
              <a href="/contact.php" class="<?= $_SERVER['REQUEST_URI'] == "/contact.php" ? "bg-gray-900 text-white " : "text-gray-300 " ?>
